...
export const metadata: Metadata = {
  ...
  description: "Browse United Aluminum inventory, stock levels, and request a quote.",
};
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-navy-600">
          {stats.total} items in the live United Aluminum catalog.
          Search by SKU, filter by category, and send a quote request for anything you need.
        </p>
      </div>
